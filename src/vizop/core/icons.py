...
_PERSON = _make_path(
    ...
    [
        ...
        _M, _L, _C, _C, _C, _C, _C, _L, _L, _C, _C, _C, _C, _L, _L, _Z,
    ],
)
...
_HEART = _make_path(
    [
        ...
        (0.50, 0.25), (1.00, 0.50), (1.00, 0.72),
        # Curve 2: right lobe curving to center dip
        (1.00, 0.92), (0.72, 1.00), (0.50, 0.78),
        # Curve 3: left lobe from center dip
        (0.28, 1.00), (0.00, 0.92), (0.00, 0.72),
        # Curve 4: left side going down to bottom tip
        (0.00, 0.50), (0.50, 0.25), (0.50, 0.10),
        # CLOSEPOLY
        (0.50, 0.10),
    ],
    [_M, _C, _C, _C, _C, _C, _C, _C, _C, _C, _C, _C, _C, _Z],
